...
//	}
	...
	public void testCount() throws Exception {
		log.info("count 요청결과 모델데이터" +		
				mockMvc.perform(MockMvcRequestBuilders.post("/todo/count")).andReturn().getModelAndView().getModelMap()
				);
	}
